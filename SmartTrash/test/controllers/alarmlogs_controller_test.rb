...
class AlarmlogsControllerTest < ActionController::TestCase
  ...
  test "should create alarmlog" do
    assert_difference('Alarmlog.count') do
      post :create, alarmlog: { code: @alarmlog.code, mobile: @alarmlog.mobile, sendmsg: @alarmlog.sendmsg, user_id: @alarmlog.user_id }
    end
  ...
  test "should update alarmlog" do
    patch :update, id: @alarmlog, alarmlog: { code: @alarmlog.code, mobile: @alarmlog.mobile, sendmsg: @alarmlog.sendmsg, user_id: @alarmlog.user_id }
    assert_redirected_to alarmlog_path(assigns(:alarmlog))
  end
