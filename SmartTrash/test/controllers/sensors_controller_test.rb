...
class SensorsControllerTest < ActionController::TestCase
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post :create, sensor: { name: @sensor.name, sensorSign: @sensor.sensorSign, sensorType: @sensor.sensorType, sensorUnit: @sensor.sensorUnit }
    end
  ...
  test "should update sensor" do
    patch :update, id: @sensor, sensor: { name: @sensor.name, sensorSign: @sensor.sensorSign, sensorType: @sensor.sensorType, sensorUnit: @sensor.sensorUnit }
    assert_redirected_to sensor_path(assigns(:sensor))
  end
