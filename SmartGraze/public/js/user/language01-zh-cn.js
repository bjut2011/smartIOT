...
var allPage = { deviceNo: "设备号(ID)", search: "搜索", tracking: "实时跟踪", playback: "历史轨迹", monitor: "定位监控", home: "主页", customer: "我的客户", message: "消息", exit: "退出",
    ...
    createTime: "创建时间", activeTime: "激活时间", hireExpireTime: "到期时间", edit: "修改", more: "设置", deletes: "删除", cusName: "客户名", userInfo: "用户信息", plsSelUser: "请选择一个用户!",
...
var yiwen201407 = { nowPosition: "当前位置", message: "消息中心", moveCustomer: "客户转移", importExcel: "导出Excel", moveMsg1: "不能将客户转移给自己或下级客户!",
    ...
    moveMsg8: "转移成功!", userList: "用户列表", setSOS: "设置白名单", sosPhone: "SOS号码", setQinqing: "设置亲情号码", qqPhone: "亲情号码", elec: "电量",
    gsm0: "无信号", gsm1: "信号极弱", gsm2: "信号较弱", gsm3: "信号良好", gsm4: "信号强", deviceStatus: "状态查询", restart: "远程重启", setUploadTimeMsg: "间隔不能小于10秒!",
    moreCommand: "更多指令", centerPhone: "SOS1号码", version: "版本查询", touchuan: "透传"
}

var yiwen201409 = { commandClass: "指令分类", controlCommand: "控制指令", setCommand: "设置指令", queryCommand: "查询指令", commandType: "指令类型" }

var yiwen201504 = { bjkg: "报警开关", bjfs: "报警方式", ptbj: "平台报警", ptdxbj: "短信和平台报警", ptdxdhbj: "平台和短信和电话报警", jtms: "接听模式", ajjt: "按键接听",
    mtzdjt: "免提自动接听", jyzdjt: "静音自动接听", mdrms: "免打扰模式", ms: "模式", bqyfsr: "防骚扰关闭", qyfsr: "防骚扰开启", zsd: "指示灯", kai: "开", guan: "关",
    zscpt: "只上传平台", dxdhpt: "先短信,后电话,再上传到平台", dhpt: "电话和平台报警", qxzcgq: "请选择传感器", xmsj: "休眠时间", xs: "限速", shengyin: "声音", zhendong: "震动",
    menci: "门磁", qbdk: "全部打开", sosjc: "防盗感应", qbcx: "全部撤销", zsdsz: "指示灯设置", dxyy: "短信语言", fsrms: "防骚扰模式", hqdlxhgps: "获取电量,GSM信号和GPS卫星",
    dcdw: "单次定位", xinhao: "信号", jibie: "级", zdbjk: "震动报警开", sybjk: "声音报警开", mcbjk: "门磁感应报警开", fdbjk: "防盗报警开", sos2: "SOS2号码", yuyan: "语言", hfch: "恢复出厂",
    gsmxh: "GSM信号", gpsxh: "GPS信号", xm: "休眠", dcdl: "电池电量", sfzt: "设防状态", usersList: "用户列表", upmsg1: "注:上传间隔对待机时间有影响,<br />请按实际使用情况及时调整定位间隔．"
}

var yiwen201505 = { userhire: "用户到期", timeZone: "设备时区" }

var yiwen201508 = { kaimen: "开门", guanmen: "关门", shengyin: "声音报警", horn: "设置本地报警声音", upgrade: "远程升级" }